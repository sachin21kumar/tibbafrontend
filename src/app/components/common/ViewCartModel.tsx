          ...
          >
            ...
            {cart?.items?.length > 0 ? (
              <div className="divide-y divide-gray-200">
                {cart?.items?.map((item: any) => (
                  <div
                    ...
                    className="flex items-center justify-between p-6 border-b border-b-gray-200"
                  >
                    <div>
              ...
              <div className="p-6">
                ...
                <button
                  className="w-full rounded-full bg-[#d1a054] py-4
                  text-lg font-medium text-white shadow-md cursor-pointer
                  hover:opacity-90"
